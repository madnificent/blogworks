...
(defpackage :blogworks.site
  ...
  (:export :welcome :new-user :create-user :login :personal-user-page :public-user-page :logout :blog-page :post-page :new-blog :create-blog :new-post :create-post :create-comment)
